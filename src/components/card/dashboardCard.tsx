...
export default function DashboardCard({ product }: { product: Product }) {
  ...
  return (
    <div className="w-full bg-white rounded overflow-hidden shadow-sm border border-gray-100 mb-4 transition-all">
      ...
      <div className={`md:hidden overflow-hidden transition-all duration-300 ${expanded ? 'max-h-48' : 'max-h-0'}`}>
        <div className="px-4 pb-4 pt-1 border-t border-gray-100">
          ...
          <div className="flex justify-between">
            ...
            <button className="flex-1 py-1 text-sm text-red-500 border border-red-500 rounded hover:bg-red-50">
              Eliminar
            </button>
          </div>
        </div>
